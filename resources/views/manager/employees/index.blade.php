                ...
                <div class="p-6 text-gray-900">
                                    ...
                                    @foreach($employees as $employee)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('manager.employees.qr-form', $employee->id) }}" class="text-indigo-600 hover:text-indigo-900">
                                                    {{ $employee->qr_code_path ? 'Update QR' : 'Upload QR' }}
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach
                    ...
                    @else
                        <div class="bg-gray-50 p-4 rounded-md">
                            <p class="text-gray-700">No employees found.</p>
                        </div>
                    @endif
                </div>
            </div>
